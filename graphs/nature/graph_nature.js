$(function() {
   var options = {
    ...
    chart: {renderTo: 'graph_nature', type: 'column', zoomType: 'y', backgroundColor: '#f6f6f6'},
    title: {text: 'Répartition par types de natures de matériaux.'},
    subtitle: { text: ''},
    xAxis: {categories: []},
    ...
    $.get('../graphs/nature/data_graphs/nature_tous.csv', function(data) {
    var lines = data.split('\n');
        ...
        $('button').click(function() {
            selection_site = ['nature_tous', 'nature_boucaniers', 'nature_saint_frieux', 'nature_zuydcoote']
